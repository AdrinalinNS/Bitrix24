...
Программа автоматически определяет сотрудников, у которых сегодня день рождения, генерирует персонализированные поздравления с помощью Yandex GPT и отправляет их в общий чат Битрикс24 вместе с праздничными открытками.
